...
[System.Windows.Forms.MessageBox]::Show("DONE", "Windows Defender | Update Windows", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
Exit
